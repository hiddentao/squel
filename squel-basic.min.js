...
c.flavours={},c.useFlavour=function(a){var b;if(null==a&&(a=null),!a)return c;if(c.flavours[a]instanceof Function)return b=d(a),c.flavours[a].call(null,b),b;throw new Error("Flavour not available: "+a)}}).call(this);