  ...
  cls.Expression = class extends cls.BaseBuilder {
    ...
    _toParamString (options = {}) {
      ...
      for (let nodeIndex in this._nodes) {
        let { type, expr,  para } = this._nodes[nodeIndex];
  ...
  */
  ...
  cls.Case = class extends cls.BaseBuilder {
    ...
    _toParamString (options = {}) {
      ...
      for (let caseIndex in this._cases) {
        const { expression, values, result } = this._cases[caseIndex]
  ...
  */
  cls.Block = class extends cls.BaseBuilder {
    constructor (options) {
      ...
      this._recalculateExposedMethods()
    }
    ...
    */
    ...
    _toParamString (options = {}) {
      ...
      if (this._hasTable()) {
        ...
        for (let tableIndex in this._tables) {
          const { table, alias } = this._tables[tableIndex]
  ...
  cls.GetFieldBlock = class extends cls.Block {
    ...
    */
    ...
    _toParamString (options = {}) {
      ...
      for (let fieldIndex in this._fields) {
        totalStr = _pad(totalStr, ", ");

        let { name, alias, options } = this._fields[fieldIndex];
  ...
  cls.AbstractConditionBlock = class extends cls.Block {
    ...
    */
    ...
    _toParamString (options = {}) {
      ...
      for (let conditionIndex in this._conditions) {
        const { expr, values } = this._conditions[conditionIndex]
  ...
  cls.OrderByBlock = class extends cls.Block {
    ...
    */
    ...
    _toParamString (options = {}) {
      ...
      for (let orderIndex in this._orders) {
        const { field, dir, values } = this._orders[orderIndex]
  ...
  cls.JoinBlock = class extends cls.Block {
    ...
    */
    ...
    _toParamString (options = {}) {
      ...
      for (let joinIndex in this._joins) {
        const { type, table, alias, condition } = this._joins[joinIndex]
  ...
  cls.UnionBlock = class extends cls.Block {
    ...
    */
    ...
    _toParamString (options = {}) {
      ...
      for (let unionIndex in this._unions) {
        const { type, table } = this._unions[unionIndex]
